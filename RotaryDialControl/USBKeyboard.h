...
class USBKeyboard {
 public:
  ...
  void sendKeyStroke(byte keyStroke, byte modifiers) {
    ...
    Serial.write(keyNone, 1);          // Reserved
    Serial.write(keyStroke);     // Keycode 1
    Serial.write(keyNone, 1);          // Keycode 2  
    Serial.write(keyNone, 1);          // Keycode 3
    Serial.write(keyNone, 1);          // Keycode 4
    Serial.write(keyNone, 1);          // Keycode 5
    Serial.write(keyNone, 1);          // Keycode 6  
